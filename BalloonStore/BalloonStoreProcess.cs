...
namespace BalloonStore
{
    public class BalloonStoreProcess : CommunicationProcess  {
        ...
        public void initializeSubsystem(string registryEp) {
            log.Debug("Initializeing BalloonStore Subsystem.");
            initializeSubsystem(
                new BalloonStoreConversationFactory(), 
                new BalloonStoreEndpointLookup( registryEp ));
        }
        ...
        public void Reset() {
            ...
            BalloonStoreState.OpenGames = null;
        }
